...
function PricingSection() {
    ...
    return (
        <section className="flex flex-col items-center py-16 md:py-18 w-full">
            <h2 className=" text-center font-black  dark:text-slate-100 text-3xl md:text-4xl mb-8"> Simple, <span className='text-primary'>Transparent</span> Pricing</h2>
            ...
            <div className="flex justify-center flex-col lg:flex-row w-full gap-10">
                <div id='hobby' className="p-8 rounded-xl flex flex-col justify-start dark:shadow-zinc-900/90 border border-zinc-300 dark:border-zinc-600 gap-3 shadow-2xl overflow-hidden flex-1">
                ...
                <div id='pro' className="p-8 rounded-xl flex flex-col justify-start border border-primary dark:bg-zinc-900 gap-3 overflow-hidden flex-1 relative shadow-lg shadow-primary">
